...
Add-Result (($webModuleText -match 'class="action-menu topbar-export"') -and ($webModuleText -match 'data-export-excel') -and ($webModuleText -match 'data-export-word') -and ($webModuleText -match 'data-export-html')) 'Excel・Word・HTMLを出力メニューへまとめる'
