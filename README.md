...
普段のEdge・Excelなどの操作を記録し、操作前／操作後の画面とクリック位置をもとに、部内向けの操作マニュアルをローカルで組み立てるWindowsアプリです。Microsoft 365 Copilotによる場面・文章の精査は任意で、使えない場合も編集と出力を続けられます。既存録画や画像からの作成も選べます。
