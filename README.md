...
**出力する前にExcel・Wordを閉じてください。** ManualBuilderは、利用者が開いている
未保存のブックや文書を壊さないことを最優先にしているため、Excel／Wordが起動していると
出力を開始せずに中止します。記録の対象がExcel操作そのものである場合が多いので、
記録が終わったらExcelを閉じてから出力へ進んでください。
